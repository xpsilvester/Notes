...
​[网站pv uv 停留时间 等统计](https://blog.csdn.net/aibisoft/article/details/40430815)
...
3. 单页面应用（vue）自身跳转通过重写pushState和replaceState，然后监听两个自定义事件
4. visibilitychange监听tab切换
5. window.onpopstate监听页面跳转
     ```
